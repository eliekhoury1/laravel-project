...
@if(session('id'))
     ...
     @endif
  @else 
  <script>window.location = "/signin/create";</script> 3a login li2an awal if btshouf eza 3mil login wala la2(url tb3a sa7)
@endif
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripe.payment',['tot'=>$data])}}" method="post" class="validation"
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-danger btn-lg btn-block" type="submit">Pay Now (${{$data}})</button>
                            </div>
                        </div>
